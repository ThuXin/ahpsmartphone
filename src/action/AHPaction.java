...
public class AHPaction extends HttpServlet{
	
	
	public static HttpServletRequest req=ServletActionContext.getRequest();
	/**
     * Question to compare
     */
    ...
    * @param labels
    */
   public AHPaction (String labels[]) {
       this(labels.length);
       this.labels = labels;
   }
    ...
    */
   public AHPaction (int nrAlternatives) {
 ...
 public void setPairwiseComparisonArray(double a[]) {
     int i = 0;
     for (int row = 0; row < nrAlternatives; row++) {             //System.out.println(row + "/" + col + "=" + a[i]);
