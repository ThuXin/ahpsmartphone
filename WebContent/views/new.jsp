...
<body style="font-size: 1.3rem;">
	...
	<div>
		<nav class="navbar navbar-expand-lg navbar-light ">
			<a class="navbar-brand animate__animated animate__swing " href="#"><span
				style="font-size: 2rem;">Project-A</span></a>
			...
			<div class="collapse navbar-collapse justify-content-end mr-5"
				...
				<ul class="navbar-nav">
					<li class="nav-item active mr-5"><a class="nav-link "
						href="index.html"><i class="fas fa-home  pr-1"></i>Home</a></li>
					<li class="nav-item mr-5"><a class="nav-link "
						href="ContactUs.html"><i class="fas fa-address-card  pr-1"></i>Contact</a>
					</li>
					<li class="nav-item mr-5"><a class="nav-link"
						href="index.html#aboutUs"><i
							class="fas fa-file-signature  pr-1"></i>About Us</a></li>
				</ul>
			</div>
		</nav>
		<hr>
	...
	<div style="background-color: #091625; border: none;" id="aboutUs">
		...
		<p class="text-white p-2">Lorem ipsum dolor sit amet consectetur
			adipisicing elit. Atque facere, odit voluptate expedita repellat, vel
			natus nostrum quia quibusdam cum quis, aut blanditiis vitae iusto
			neque nesciunt possimus ipsa. Eum!</p>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
			<path fill="#fff" fill-opacity="1"
